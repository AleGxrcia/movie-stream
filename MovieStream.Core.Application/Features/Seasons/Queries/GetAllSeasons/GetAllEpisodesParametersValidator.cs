...
{
    public class GetAllSeasonsParametersValidator : AbstractValidator<GetAllSeasonsParameters>
    {
        ...
        public GetAllSeasonsParametersValidator()
        {
            ...
            RuleFor(x => x.PageSize)
                .InclusiveBetween(1, GetAllSeasonsParameters.MaxPageSize)
                .WithMessage($"PageSize must be between 1 and {GetAllSeasonsParameters.MaxPageSize}.");
