...
{
    public class MoviesParametersValidator : AbstractValidator<MovieParameters>
    {
        public MoviesParametersValidator()
        {
            ...
            //    .InclusiveBetween(1, MovieParameters.MaxPageSize)
            //    .WithMessage($"PageSize must be between 1 and {MovieParameters.MaxPageSize}.");
