        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TvSeries_ProductionCompanies_ProductionCompanyId",
                        column: x => x.ProductionCompanyId,
                        principalTable: "ProductionCompanies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Seasons_TvSeries_TvSerieId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TvSeriesGenre", x => new { x.GenresId, x.TvSeriesId });
                    table.ForeignKey(
                        name: "FK_TvSeriesGenre_Genres_GenresId",
                        column: x => x.GenresId,
                        principalTable: "Genres",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TvSeriesGenre_TvSeries_TvSeriesId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Runtime = table.Column<TimeSpan>(type: "time", nullable: false),
                    ReleaseDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    StreamingUrl = table.Column<string>(type: "varchar(max)", unicode: false, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Seasons_TvSerieId",
                table: "Seasons",
                column: "TvSerieId");

            migrationBuilder.CreateIndex(
                name: "IX_TvSeries_ProductionCompanyId",
                table: "TvSeries",
                column: "ProductionCompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_TvSeriesGenre_TvSeriesId",
                table: "TvSeriesGenre",
                column: "TvSeriesId");
        }
